...
public class ReadCommittedTestCase {
	...
	public static final String TEST_DS_XML = "readcommitted-ds.xml";
	...
	public static JavaArchive createJavaDeployment() {
		final JavaArchive jar = create(JavaArchive.class, "readcommitted-test.jar");
		jar.addPackage(MyCallableTask.class.getPackage());
		jar.addClass(Account.class);
		jar.addAsManifestResource(new FileAsset(new File("src/test/resources/isolations/readcommitted-test.xml")),
				"persistence.xml");
